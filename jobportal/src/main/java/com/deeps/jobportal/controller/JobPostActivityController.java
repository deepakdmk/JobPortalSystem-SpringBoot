...
import com.deeps.jobportal.service.JobSeekerApplyService;
import com.deeps.jobportal.service.JobSeekerSaveService;
...
public class JobPostActivityController {
	...
	public JobPostActivityController(UsersService springUsersService,
			JobPostActivityService springJobPostActivityService, JobSeekerApplyService springJobSeekerApplySerivce,
			JobSeekerSaveService springJobSeekerSaveService) {
		this.usersService = springUsersService;
		this.jobPostActivityService = springJobPostActivityService;
		this.jobSeekerApplyService = springJobSeekerApplySerivce;
		this.jobSeekerSaveService = springJobSeekerSaveService;
	}
